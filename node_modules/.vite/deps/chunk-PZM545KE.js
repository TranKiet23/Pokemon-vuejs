...
var getTransitionName = (rootPrefixCls, motion, transitionName2) => {
...
var APPEND_ORDER2 = "data-vc-order";
var MARK_KEY2 = "vc-icon-key";
...
function findStyles2(container) {
  return Array.from((containerCache2.get(container) || container).children).filter(function(node2) {
...
function injectCSS2(css) {
  ...
  if (prepend) {
    if (prepend === "queue") {
      var existStyle = findStyles2(container).filter(function(node2) {
        return ["prepend", "prependQueue"].includes(node2.getAttribute(APPEND_ORDER2));
      });
      if (existStyle.length) {
        container.insertBefore(styleNode, existStyle[existStyle.length - 1].nextSibling);
        return styleNode;
...
function findExistNode2(key2) {
  var option = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
  var container = getContainer2(option);
  return findStyles2(container).find(function(node2) {
    return node2.getAttribute(getMark2(option)) === key2;
  });
}
...
function updateCSS2(css, key2) {
  ...
  var newNode = injectCSS2(css, option);
...
function generate2(node2, key2, rootProps) {
  if (!rootProps) {
    return h(node2.tag, _objectSpread({
      key: key2
    }, node2.attrs), (node2.children || []).map(function(child, index) {
      return generate2(child, "".concat(key2, "-").concat(node2.tag, "-").concat(index));
    }));
  }
  return h(node2.tag, _objectSpread({
    key: key2
...
var useInsertStyles = function useInsertStyles2() {
  ...
  nextTick(function() {
    ...
    updateCSS2(mergedStyleStr, "@ant-design-vue-icons", {
      prepend: true,
      csp: csp.value,
      attachTo: shadowRoot
    });
...
var IconBase = function IconBase2(props, context) {
  var _props$context$attrs = _objectSpread3({}, props, context.attrs), icon = _props$context$attrs.icon, primaryColor = _props$context$attrs.primaryColor, secondaryColor = _props$context$attrs.secondaryColor, restProps = _objectWithoutProperties(_props$context$attrs, _excluded);
...
var Icon = function Icon2(props, context) {
  ...
  var classObj = (_classObj = {}, _defineProperty4(_classObj, rootClassName.value, !!rootClassName.value), _defineProperty4(_classObj, prefixCls.value, true), _defineProperty4(_classObj, "".concat(prefixCls.value, "-").concat(icon.name), Boolean(icon.name)), _defineProperty4(_classObj, "".concat(prefixCls.value, "-spin"), !!spin || icon.name === "loading"), _classObj);
...
var style_default2 = genComponentStyleHook("Notification", (token2) => {
...
function getCloseIcon(prefixCls, closeIcon) {
  ...
  }, [createVNode(CloseOutlined_default2, {
    "class": `${prefixCls}-close-icon`
  }, null)]);
}
var TypeIcon = {
  info: createVNode(InfoCircleFilled_default2, null, null),
  success: createVNode(CheckCircleFilled_default2, null, null),
  error: createVNode(CloseCircleFilled_default2, null, null),
  warning: createVNode(ExclamationCircleFilled_default2, null, null),
  loading: createVNode(LoadingOutlined_default2, null, null)
};
var typeToIcon = {
...
function useInternalNotification(notificationConfig) {
  ...
  const open = (config) => {
    ...
    const {
      ...
      btn,
      class: className
    } = config, restConfig = __rest3(config, ["message", "description", "icon", "type", "btn", "class"]);
...
function getNotificationInstance(_ref, callback) {
  let {
    ...
    getContainer: getContainer4 = defaultGetContainer,
    top,
    bottom,
  ...
  vc_notification_default.newInstance({
    ...
    closeIcon: (_ref2) => {
      ...
      }, [renderHelper(closeIcon, {}, createVNode(CloseOutlined_default2, {
...
function getStyle2(globalPrefixCls, theme) {
  const variables = {};
...
function registerTheme(globalPrefixCls, theme) {
  const style = getStyle2(globalPrefixCls, theme);
  if (canUseDom_default()) {
...
var ConfigProvider = defineComponent({
  ...
  setup(props, _ref) {
    ...
    const wrapSSR = style_default3(iconPrefixCls);
    ...
    const renderEmptyComponent = (name) => {
      const renderEmpty2 = props.renderEmpty || slots.renderEmpty || parentContext.renderEmpty || renderEmpty_default;
    ...
    const memoTheme = computed(() => {
      const _a = mergedTheme.value || {}, {
        algorithm,
        token: token2
      } = _a, rest = __rest4(_a, ["algorithm", "token"]);
    ...
    const validateMessagesRef = computed(() => {
      ...
      if (locale4.value) {
        validateMessages = ((_a = locale4.value.Form) === null || _a === void 0 ? void 0 : _a.defaultValidateMessages) || ((_b = en_US_default6.Form) === null || _b === void 0 ? void 0 : _b.defaultValidateMessages) || {};
      }
...
Notification.newInstance = function newNotificationInstance(properties, callback) {
  const _a = properties || {}, {
    ...
    useStyle: useStyle2
  } = _a, props = __rest5(_a, ["name", "getContainer", "appContext", "prefixCls", "rootPrefixCls", "transitionName", "hasTransitionName", "useStyle"]);
  const div = document.createElement("div");
  if (getContainer4) {
    const root = getContainer4();
...
function useNotification() {
  ...
  const {
    getContainer: getContainer4 = defaultGetContainer2,
    motion,
    prefixCls,
    maxCount: maxCount3,
    getClassName,
    getStyles,
    onAllRemoved
  } = rootConfig, shareConfig = __rest6(rootConfig, ["getContainer", "motion", "prefixCls", "maxCount", "getClassName", "getStyles", "onAllRemoved"]);
...
var style_default4 = genComponentStyleHook("Message", (token2) => {
...
var PurePanel_default2 = defineComponent({
  ...
  setup(props, _ref2) {
    ...
    const [, hashId] = style_default4(prefixCls);
...
function useInternalMessage(messageConfig) {
  ...
  const open = (config) => {
    ...
    const {
      ...
      class: className,
      onClose
    } = config, restConfig = __rest7(config, ["content", "icon", "type", "key", "class", "onClose"]);
    let mergedKey = key2;
...
var getContainer3 = () => document.body;
var maxCount2;
var rtl2 = false;
...
function setMessageConfig(options) {
  ...
  if (options.getContainer !== void 0) {
    getContainer3 = options.getContainer;
    messageInstance = null;
  }
...
function getMessageInstance(args, callback) {
  ...
  vc_notification_default.newInstance({
    ...
    getContainer: getContainer3 || args.getPopupContainer,
    maxCount: maxCount2,
    name: "message",
    useStyle: style_default4
  }, (instance) => {
    if (messageInstance) {
      callback(messageInstance);
      return;
    ...
    getMessageInstance(args, (instance) => {
      instance.notice({
        ...
        content: (_ref) => {
          ...
          const Icon3 = typeToIcon3[args.type];
...
//# sourceMappingURL=chunk-PZM545KE.js.map
